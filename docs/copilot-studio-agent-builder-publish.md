...
- Select the ellipses (**...**) and **Edit** from a agent on the right rail in Microsoft Copilot.
...
The agent author can delete their existing agents. After deletion, the agent will no longer be available to the author or shared users to use in Microsoft Copilot.
