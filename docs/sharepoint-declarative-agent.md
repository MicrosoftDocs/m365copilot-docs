...
For specific information on how to build a declarative agent from within SharePoint, see [Anyone can create copilots from SharePoint in a few clicks](https://techcommunity.microsoft.com/blog/spblog/microsoft-build-2024-create-custom-copilots-from-sharepoint/4146527#:%7E:text=Anyone%20can%20create%20copilots%20from%20SharePoint%20in%20a%20few%20clicks:~:text=Anyone%20can%20create%20copilots%20from%20SharePoint%20in%20a%20few%20clicks
