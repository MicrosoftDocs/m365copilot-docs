...
For more information on how to enable and disable Pay-as-you-go consumption of the Retrieval API, as well as pricing, see (LINK TO RETRIEVAL PAYG DOCS).
