---
title: Plugin manifest schema 2.1 for Microsoft 365 Copilot
description: Learn about the 2.1 schema for a manifest file for a plugin in Microsoft 365 Copilot
author: jasonjoh
ms.author: jasonjoh
...
The following article describes the 2.1 schema used by API plugin manifest files. For more information about API plugins, see [Plugins for Microsoft 365 Copilot](./overview-plugins.md).
