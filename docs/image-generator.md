...
If you're the using [Microsoft 365 Copilot](agent-builder-introduction.md) to create your agent, on the **Configure** tab, under **Capabilities**, choose the toggle next to **Create images**.
...
> [!NOTE]
> The image generator doesn't currently work in the test pane in Microsoft 365 Copilot.
