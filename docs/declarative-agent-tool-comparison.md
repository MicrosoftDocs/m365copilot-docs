...
| **Advanced support for Adaptive Cards:** Enables custom UI rendering inside agents by using [Adaptive Cards](/training/modules/copilot-declarative-agent-action-api-plugin-adaptive-cards-vsc/), with the most advanced authoring experience among the available tools. |   |
