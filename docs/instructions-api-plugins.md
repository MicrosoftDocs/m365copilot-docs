...
:::image type="content" source="assets/images/instruction-api-plugins-h.png" alt-text="Diagram showing the four manifest files that each reference the other" border="false":::
