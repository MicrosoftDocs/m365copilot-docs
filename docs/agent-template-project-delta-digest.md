...
> [!IMPORTANT]
> This template works best when grounded in additional context - preferably in Copilot Connectors (recommended under Extension Opportunities), or a SharePoint knowledge source. Use the Agent Builder to search for [one of the recommended Copilot Connectors](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/agent-builder-add-knowledge#copilot-connectors), or [a SharePoint file, folder or site](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/agent-builder-add-knowledge#sharepoint-content) that provides authoritative project information relevant to this agent.
