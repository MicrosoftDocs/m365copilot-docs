...
- **Custom knowledge** to connect Microsoft 365 data sources (such as Teams messages, Copilot connectors, SharePoint, and OneDrive) or external data via Copilot connectors.
