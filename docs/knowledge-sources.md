...
For information about how to add Microsoft Graph connectors as knowledge to your agent manifest in Agents Toolkit, see [Microsoft Graph connectors object](declarative-agent-manifest-1.4.md#microsoft-graph-connectors-object).
