...
> [!NOTE]
> When using `Action.OpenUrl`, make sure to include the domain of the target URL in the [validDomains](/microsoft-365/extensibility/schema/root?view=m365-app-1.25&tabs=syntax) section of your app manifest. If the domain isn’t listed, Teams displays the message **URL may lead to untrusted content**.
