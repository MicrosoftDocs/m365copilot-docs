...
During the public preview, customers with a Copilot license can extend Copilot and build plugins. For the requisites to create conversational and AI plugins with Copilot Studio see: [Create and configure copilot plugins with Copilot Studio](/power-virtual-agents/copilot-plugins-overview.md##prerequisites).
