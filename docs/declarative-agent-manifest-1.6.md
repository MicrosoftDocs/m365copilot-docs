...
Indicates that the declarative agent can search for information about people in the organization. Refer to [People knowledge](agent-builder-add-knowledge.md#people-data) for more details on the data returned by base People capability.
