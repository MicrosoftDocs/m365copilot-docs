...
If successful, this method returns a `200 OK` response code and a collection of [copilotPackageDetail](resources/copilotpackagedetail.md) object in the response body.
