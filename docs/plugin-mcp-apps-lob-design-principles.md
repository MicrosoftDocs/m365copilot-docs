...
Use [Work IQ](./work-iq/index.md) when Microsoft 365 work context can improve the task. It can help ground requests involving “my” and provide relevant context for creating or updating records.
...
:::image type="content" source="assets/images/lob-mcp-apps/focused-tools-and-shared-widgets.png" lightbox="assets/images/lob-mcp-apps/focused-tools-and-shared-widgets.png" alt-text="Comparison of one unrestricted MCP tool with focused tools that reuse list, form, and detail widgets":::
...
:::image type="content" source="assets/images/lob-mcp-apps/record-name-to-id-resolution.png" lightbox="assets/images/lob-mcp-apps/record-name-to-id-resolution.png" alt-text="Three-step record resolution showing a search by name, deliberate match selection, and editing by stable record ID":::
...
:::image type="content" source="assets/images/lob-mcp-apps/server-side-filtered-list.png" lightbox="assets/images/lob-mcp-apps/server-side-filtered-list.png" alt-text="Three-step filtering process showing a business request mapped to a declared tool filter and returned as one filtered list":::
...
:::image type="content" source="assets/images/lob-mcp-apps/batch-related-name-resolution.png" lightbox="assets/images/lob-mcp-apps/batch-related-name-resolution.png" alt-text="Three-step batch resolution process showing record retrieval, collection of unique foreign keys, and a list containing resolved customer and owner names":::
...
:::image type="content" source="assets/images/lob-mcp-apps/relationship-record-selection.png" lightbox="assets/images/lob-mcp-apps/relationship-record-selection.png" alt-text="Relationship selection panel showing two matching authorized accounts and one restricted account before creating a record":::
