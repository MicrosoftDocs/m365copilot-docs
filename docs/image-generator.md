...
If you're the using [Microsoft 365 Copilot](copilot-studio-lite.md) to create your agent, on the **Configure** tab, under **Capabilities**, choose the toggle next to **Image generator**.
