...
| **Executive messaging** | Drafting high-stakes communications from leadership (CEO, directors, etc.). The agent helps produce polished emails and memos for executives, maintaining a professional and authoritative tone for things like CEO announcements, board updates, leadership blog posts. It helps ensure that they remain on-message and are aligned with the organization's brand. |
