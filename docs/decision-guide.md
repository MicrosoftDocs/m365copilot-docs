...
|  Copilot Studio conversational plugins         |  - No adaptive card support <br/> - No custom parameters support    |   - [No Continuous Integration experience](#no-continuous-integration-experience)    |
