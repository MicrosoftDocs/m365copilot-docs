...
> [!NOTE]
> The lite experience in Copilot Studio for Microsoft 365 does not support blocking general AI knowledge from your agent. For stricter control over knowledge sources, you must use the full experience in Copilot. For more information, see [Orchestrate agent behavior with generative AI](/microsoft-copilot-studio/advanced-generative-actions.md).
