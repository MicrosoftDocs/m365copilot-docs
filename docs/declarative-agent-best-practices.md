...
| Conversation starters (sample prompts)  | Examples of queries a user can ask the agent, shown as suggestions or help tips.  | Include a minimum of three sample prompts that reflect the core capabilities of your agent. These help users understand how to use the agent. For example: <br><ul><li> Draft an email to **person** about **subject**. <br><br></li><li> Compare and contrast the proposals in **file** and **file**.<br><br></li> <li>Create a line graph to show sales trends over the last six months.</li></ul> |

## Best practices for agent instructions

The instructions you provide determine your agent's behavior and help it to deliver accurate, useful responses. Poorly crafted instructions can lead to ambiguity, inconsistent outputs, or unintended actions. In general, apply the best practices defined in the [Write effective instructions for declarative agents](declarative-agent-instructions.md) article when you develop your agent. This section provides information about how you can plan, test, and iterate to enhance your agent's behavior.
