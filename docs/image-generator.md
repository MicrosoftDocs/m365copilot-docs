...
If you're the using the [Copilot Studio](copilot-studio-lite.md) lite experience to create your agent, on the **Configure** tab, under **Capabilities**, choose the toggle next to **Create images**.
