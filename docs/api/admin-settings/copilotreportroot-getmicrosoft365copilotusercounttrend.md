...
<!-- {
  ...
  "name": "copilotreportroot-getmicrosoft365copilotusercounttrend-permissions"
}
-->
[!INCLUDE [permissions-table](./includes/permissions/copilotreportroot-getmicrosoft365copilotusercounttrend-permissions.md)]
...
-->
``` http
GET /copilotRoot/reports/getMicrosoft365CopilotUserCountTrend
```
...
<!-- {
  "blockType": "request",
  "name": "copilotreportrootthis.getmicrosoft365copilotusercounttrend"
}
-->
``` http
GET https://graph.microsoft.com/beta/copilotRoot/reports/getMicrosoft365CopilotUserCountTrend(period='D7')
```
