...
By accessing or using the Microsoft 365 Copilot Chat API, you're agreeing to the [Microsoft 365 Copilot APIs Terms of Use (preview)](/legal/copilot-apis/terms-of-use?context=/microsoft-365-copilot/extensibility/context).
