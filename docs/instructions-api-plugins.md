...
:::image type="content" source="assets/images/api-plugin-manifests-2.png" alt-text="Diagram showing the four manifest files that each reference the other" border="false":::
