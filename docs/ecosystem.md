...
> [!NOTE]
> Some agent capabilities are only available to licensed Microsoft 365 Copilot users or Copilot Chat users in organizations with metered usage. For details, see [Agent capabilities for licensed, metered, and unlicensed users](#agent-capabilities-for-microsoft-365-users).
