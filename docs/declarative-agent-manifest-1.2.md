...
| `list_id`   | String | Optional. A unique GUID identifier for a list within a SharePoint site.<br /><br />**Note:** For the `list_id` property, lists associated with document libraries, sites, folders, or files are supported. |
