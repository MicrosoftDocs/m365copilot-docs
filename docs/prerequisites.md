...
You can use your Microsoft 365 Developer Program subscription to build agents. If you provision an instant sandbox with add-on purchases enabled, you can purchase additional services, including Microsoft 3655 Copilot, directly from within the sandbox, which enables you to build agents grounded on organizational data and access other enhanced capabilities. If you provision a Configurable Sandbox, the subscription doesn't support commerce, so you can't purchase Microsoft 365 Copilot licenses or enable pay-as-you-go billing, and agent capabilities are limited to web search grounding. For more information, see [Set up a Microsoft 365 developer sandbox subscription](/office/developer-program/microsoft-365-developer-program-get-started).
