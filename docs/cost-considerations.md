...
| **Usage cost**    | For users with Microsoft 365 Copilot add-on licenses, no additional charges. <br><br>For users without licenses:<br> - No charges for agents with instructions only or grounded only in public data.<br> - Usage charges for shared tenant data usage (for example, SharePoint, Copilot connectors). | Varies based on license:<ul><li>No charges with Copilot license.<li>Usage charges without license if shared data is used.</li></ul> |
