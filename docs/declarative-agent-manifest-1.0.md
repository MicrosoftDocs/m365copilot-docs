...
> [!NOTE]
> Declarative agents with the OneDrive and SharePoint or Microsoft Graph connectors capability are only available to licensed Microsoft 365 Copilot users and Copilot Chat users in tenants that allow metered usage.
