...
<!-- {
  ...
  "name": "copilotreportroot-getmicrosoft365copilotusageuserdetail-permissions"
}
-->
[!INCLUDE [permissions-table](./includes/permissions/copilotreportroot-getmicrosoft365copilotusageuserdetail-permissions.md)]
...
-->
``` http
GET /copilotRoot/reports/getMicrosoft365CopilotUsageUserDetail
```
...
<!-- {
  "blockType": "request",
  "name": "copilotreportrootthis.getmicrosoft365copilotusageuserdetail"
}
-->
``` http
GET https://graph.microsoft.com/beta/copilotRoot/reports/getMicrosoft365CopilotUsageUserDetail(period='D7')
```
