...
For agents that include [embedded file content](agent-builder-add-knowledge.md#embedded-file-content), Copilot indexes the first 750-1,000 pages (1.8 million characters) of each embedded file.
