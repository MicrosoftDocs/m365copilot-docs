...
> [!NOTE]
> This API also requires appropriate **app permissions** and **admin consent**. For more information, see [Permissions](../aiinteractionhistory-getallenterpriseinteractions.md#permissions).
