...
:::image type="content" source="assets/images/copilot-stack.png" border="true" alt-text="This diagram compares options between extend or build for M365" lightbox="assets/images/enterprise-copilot.png":::
