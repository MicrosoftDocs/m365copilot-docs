...
Custom engine agents are available to users with Microsoft 365 Copilot licenses via Copilot in Teams and the via the Microsoft 365 Copilot app (for preview).
