...
If you're the using [Microsoft 365 Copilot](agent-builde.md) to create your agent, on the **Configure** tab, under **Capabilities**, choose the toggle next to **Create images**.
