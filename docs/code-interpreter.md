...
If you're using the [Microsoft 365 Copilot](agent-builde.md) to create your agent and want to enable code interpreter, open the **Configure** tab and then, under **Capabilities**, choose the toggle next to **Create documents, charts, and code**.
